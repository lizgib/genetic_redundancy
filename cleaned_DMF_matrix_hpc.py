...
SMF_dict = pd.read_csv(sys.argv[2], header = None) # this should be the clean_redundancy_matrix30.tsv file depending on which temp set youre doing 
filename = sys.argv[3]
...
outfile = open('../data/fitness_data/clean/clean_DMF_matrix%s.csv' %filename, 'w')
outfile.write('Pair')
outfile.write(',')
outfile.write('Gene1')
outfile.write(',')
